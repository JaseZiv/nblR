...
You can install the released version of [**```nblR```**](https://github.com/JaseZiv/nblR/) from [GitHub](https://github.com/JaseZiv/nblR) with:
...
To get results of matches playes in the NBL since the 1979 season, use the `nbl_results()` function. This function takes in one argument - `wide_or_long` (options either 'wide' or 'long').
